...
$LogFile = "e:\MigrazioneVed\Scripts\MigrazioneSottoinsiemePerfetto01\Analyze-PerfettoTablesSchemas_Report.txt"
"Report di analisi della struttura del database per il sottoinsieme PERFETTO01 generato il $(Get-Date)" | Set-Content -Path $LogFile

# Tabelle da analizzare
$TablesToAnalyze = @(
    "M_JobCorrections",
    "IM_JobCorrectionsDetails",
    "IM_JobsBalance",
    "IM_JobsComponents",
...
Write-Host "Avvio analisi struttura tabelle PERFETTO01..." -ForegroundColor Green
