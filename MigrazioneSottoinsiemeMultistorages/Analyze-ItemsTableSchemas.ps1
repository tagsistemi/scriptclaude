...
$LogFile = "e:\MigrazioneVed\Scripts\MigrazioneSottoinsiemeMultistorages\Analyze-ItemsTableSchemas_Report.txt"
"Report di analisi della struttura del database per il sottoinsieme MULTISTORAGES generato il $(Get-Date)" | Set-Content -Path $LogFile

# Tabelle da analizzare
$TablesToAnalyze = @(
    "MA_ItemsStorageQty",
    "MA_ItemsStorageQtyMonthly",
    "MA_StorageGroups",
    "MA_Storages"
)
...
Write-Host "Avvio analisi struttura tabelle MULTISTORAGES..." -ForegroundColor Green
