...
$LogFile = "e:\MigrazioneVed\Scripts\MigrazioneSottoinsiemeOrdiniFornitore\Analyze-PurchaseTableSchemas_Report.txt"
# Inizializza/Pulisce il file di log all'inizio dell'esecuzione
"Report di analisi della struttura del database generato il $(Get-Date)" | Set-Content -Path $LogFile
...
Write-Host "Avvio dell'analisi della struttura delle tabelle..." -ForegroundColor Green
