-- Aggiorna la lunghezza di VEDMaster.dbo.gpx_righeram.Descrizione a 280 caratteri
-- Data: 2025-09-16

SET NOCOUNT ON;

DECLARE @TableName sysname = N'gpx_righeram';
DECLARE @ColumnName sysname = N'Descrizione';
