...
$LogFile = "e:\MigrazioneVed\Scripts\MigrazioneSottoinsiemeGpx\Analyze-GpxTableSchemas_Report.txt"
"Report di analisi della struttura del database per il sottoinsieme GPX generato il $(Get-Date)" | Set-Content -Path $LogFile
...
Write-Host "Avvio analisi struttura tabelle GPX..." -ForegroundColor Green
