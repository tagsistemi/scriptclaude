...
# Tabelle da migrare in ordine logico (LOTTI/Seriali)
$TablesToMigrate = @(
    # Anagrafiche/parametri prima
    "MA_LotSerialParameters",
    "MA_LotsNumbers",

    # Tabelle principali e di dettaglio
    "MA_Lots",
    "MA_SerialNumbers",

    # Quantità e movimenti per magazzino/tempo
    "MA_LotsStoragesQty",
...
Write-Host "AVVIO MIGRAZIONE TABELLE LOTTI" -ForegroundColor Cyan
