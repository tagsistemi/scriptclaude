...
$LogFile = "e:\MigrazioneVed\Scripts\MigrazioneSottoinsiemeCrossReferences\Analyze-CrossReferencesTableSchemas_Report.txt"
"Report di analisi della struttura del database per MA_CrossReferences generato il $(Get-Date)" | Set-Content -Path $LogFile
...
Write-Host "Avvio analisi struttura tabelle CROSSREFERENCES..." -ForegroundColor Green
