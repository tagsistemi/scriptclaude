...
DELETE FROM [VEDMaster].dbo.[IM_WorksProgressReport]
GO
...
DELETE FROM [VEDMaster].dbo.[IM_WorkingReports]
GO
...
DELETE FROM [VEDMaster].dbo.[IM_WorkingReportsDetails]
GO
...
DELETE FROM [VEDMaster].dbo.[IM_WPRDetails]
GO
...
DELETE FROM [VEDMaster].dbo.[IM_MeasuresBooks]
GO
...
DELETE FROM [VEDMaster].dbo.[IM_Specifications]
GO
...
DELETE FROM [VEDMaster].dbo.[IM_SpecificationsItems]
GO
...
DELETE FROM [VEDMaster].dbo.[IM_JobQuotations]
GO
...
DELETE FROM [VEDMaster].dbo.[IM_JobQuotasDetails]
GO
...
DELETE FROM [VEDMaster].dbo.[IM_JobQuotasSummary]
GO
