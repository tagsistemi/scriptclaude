-- Aumenta la dimensione delle colonne a rischio troncamento in VEDMaster per tabelle ARTICOLI
-- Modificare/duplicare blocchi secondo necessità dopo il report di analisi
-- Data: 2025-09-15

SET NOCOUNT ON;

/* ESEMPIO: adegua lunghezza di una colonna stringa in base al massimo riscontrato nei sorgenti */
