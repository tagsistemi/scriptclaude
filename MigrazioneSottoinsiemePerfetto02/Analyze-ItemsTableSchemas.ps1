...
$LogFile = "e:\MigrazioneVed\Scripts\MigrazioneSottoinsiemePerfetto02\Analyze-ItemsTableSchemas_Report.txt"
"Report di analisi della struttura del database per il sottoinsieme PERFETTO02 generato il $(Get-Date)" | Set-Content -Path $LogFile
...
Write-Host "Avvio analisi struttura tabelle PERFETTO02..." -ForegroundColor Green
