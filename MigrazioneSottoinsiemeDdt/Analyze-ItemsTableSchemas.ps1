...
$LogFile = "e:\MigrazioneVed\Scripts\MigrazioneSottoinsiemeDdt\Analyze-ItemsTableSchemas_Report.txt"
"Report di analisi della struttura del database per il sottoinsieme DDT (SaleDoc) generato il $(Get-Date)" | Set-Content -Path $LogFile

# Tabelle da analizzare (solo DDT)
$TablesToAnalyze = @(
    "MA_SaleDoc",
    "MA_SaleDocDetail",
...
Write-Host "Avvio analisi struttura tabelle DDT..." -ForegroundColor Green
