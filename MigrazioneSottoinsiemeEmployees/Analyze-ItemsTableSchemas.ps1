...
$LogFile = "e:\MigrazioneVed\Scripts\MigrazioneSottoinsiemeEmployees\Analyze-ItemsTableSchemas_Report.txt"
"Report di analisi della struttura del database per il sottoinsieme EMPLOYEES generato il $(Get-Date)" | Set-Content -Path $LogFile
...
Write-Host "Avvio analisi struttura tabelle EMPLOYEES..." -ForegroundColor Green
