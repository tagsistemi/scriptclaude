...
$TablesToMigrate = @(
    # Anagrafiche motivazioni movimenti
    "MA_InventoryReasons",
    ...
    # Dati fiscali e bilanci mensili articoli
    "MA_ItemsFiscalData",
    "MA_ItemsMonthlyBalances",

    # Movimenti di magazzino (testate e dettagli)
    "MA_InventoryEntries",
...
Write-Host "AVVIO MIGRAZIONE TABELLE MAGAZZINO" -ForegroundColor Cyan
