-- Vista [dbo].[PARTITARIONEW] - Aggiornamento
-- Generato: 2026-02-23 21:30:40

-- Eliminazione vista esistente
IF EXISTS (SELECT * FROM sys.views v INNER JOIN sys.schemas s ON v.schema_id = s.schema_id WHERE s.name = N'dbo' AND v.name = N'PARTITARIONEW')
BEGIN
    DROP VIEW [dbo].[PARTITARIONEW]
    PRINT 'Vista [dbo].[PARTITARIONEW] eliminata'
END
GO

-- Ricreazione vista
CREATE VIEW [dbo].[PARTITARIONEW]
AS
SELECT     dbo.MA_PyblsRcvblsDetails.InstallmentNo, dbo.MA_PyblsRcvblsDetails.InstallmentType, dbo.MA_PyblsRcvblsDetails.PayableAmountInBaseCurr, 
                      dbo.MA_PyblsRcvblsDetails.OpenedAdmCases, dbo.MA_PyblsRcvblsDetails.InstallmentDate, dbo.MA_PyblsRcvblsDetails.OpeningDate, 
                      ...
                      dbo.MA_PyblsRcvbls.PymtSchedId, dbo.MA_CustSupp.CompanyName, dbo.MA_CustSupp.Address, dbo.MA_CustSupp.ZIPCode, 
                      dbo.MA_CustSupp.City, dbo.MA_CustSupp.County, dbo.MA_CustSupp.Telephone1, dbo.MA_CustSupp.Telephone2, dbo.MA_CustSupp.Fax, 
                      dbo.MA_CustSupp.Internet, dbo.MA_CustSupp.ContactPerson, RIGHT(dbo.MA_PyblsRcvbls.DocNo, 3) AS rep, 
                      dbo.MA_PyblsRcvblsDetails.PaymentTerm, dbo.MA_PyblsRcvbls.Group1, dbo.MA_PyblsRcvbls.Salesperson
FROM         dbo.MA_CustSupp INNER JOIN
                      ...
                      dbo.MA_CustSupp.CustSuppType = dbo.MA_PyblsRcvblsDetails.CustSuppType
GO

PRINT 'Vista [dbo].[PARTITARIONEW] creata con successo'
GO
