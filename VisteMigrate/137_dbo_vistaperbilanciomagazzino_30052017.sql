-- Vista [dbo].[vistaperbilanciomagazzino_30052017] - Aggiornamento
-- Generato: 2026-02-23 21:30:43

-- Eliminazione vista esistente
IF EXISTS (SELECT * FROM sys.views v INNER JOIN sys.schemas s ON v.schema_id = s.schema_id WHERE s.name = N'dbo' AND v.name = N'vistaperbilanciomagazzino_30052017')
BEGIN
    DROP VIEW [dbo].[vistaperbilanciomagazzino_30052017]
    PRINT 'Vista [dbo].[vistaperbilanciomagazzino_30052017] eliminata'
END
GO

-- Ricreazione vista
CREATE VIEW [dbo].[vistaperbilanciomagazzino_30052017]
AS
...
PRINT 'Vista [dbo].[vistaperbilanciomagazzino_30052017] creata con successo'
GO
