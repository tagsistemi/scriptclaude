-- Vista [dbo].[vistaperbilanciomagazzino_12122018] - Aggiornamento
-- Generato: 2026-02-23 21:30:43

-- Eliminazione vista esistente
IF EXISTS (SELECT * FROM sys.views v INNER JOIN sys.schemas s ON v.schema_id = s.schema_id WHERE s.name = N'dbo' AND v.name = N'vistaperbilanciomagazzino_12122018')
BEGIN
    DROP VIEW [dbo].[vistaperbilanciomagazzino_12122018]
    PRINT 'Vista [dbo].[vistaperbilanciomagazzino_12122018] eliminata'
END
GO

-- Ricreazione vista
CREATE VIEW [dbo].[vistaperbilanciomagazzino_12122018]
AS
...
PRINT 'Vista [dbo].[vistaperbilanciomagazzino_12122018] creata con successo'
GO
